...
public class TC_RF_023_8_AccountRegisterHeaderValidationTest extends BaseClass {
    @Test(groups = {"Regression", "Master"})
    public void test_whenEmailFormatIncorrect_thenAccountNotCreated() {
        logger.info("");
        logger.info("***  TC_RF_023_8_AccountRegisterHeaderValidationTest ***");
        try {
            ...
            registrationPage.clickCheckout();
            logger.info("... click on 'Checkout' in navbar");
