...
public class TC_RF_011_3_AccountRegisterWithInvalidTelNumberTest extends BaseClass {
    @Test(groups = {"Regression", "Master"})
    public void test_whenEmailFormatIncorrect_thenAccountNotCreated() {
        logger.info("");
        logger.info("***  TC_RF_011_3_AccountRegisterWithInvalidTelNumberTest ***");
        try {
            ...
            String phone = "123456789012345678901234567890123";
