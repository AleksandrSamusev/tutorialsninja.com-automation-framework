...
public class TC_RF_010_03_AccountNotCreatedIfEmailIncorrectTest extends BaseClass {
    @Test(groups = {"Regression", "Master"})
    public void test_whenEmailFormatIncorrect_thenAccountNotCreated() {
        logger.info("");
        logger.info("***  Starting TC_RF_010_03_AccountNotCreatedIfEmailIncorrectTest ***");
        try {
            ...
            String mail = randomString(); //email format - <someText>
            ...
            String msg = registrationPage.getStandardEmailValidationMessage();
            logger.info("... validation message - " + msg);
            Assert.assertEquals(msg, "Please include an '@' in the email address. '" +
                    mail + "' is missing an '@'.");
        } catch (Exception ex) {
            logger.info("!! TEST FAILED !!");
            Assert.fail();
        }
        logger.info("***  Finished TC_RF_010_03_AccountNotCreatedIfEmailIncorrectTest ***");
    }
}
