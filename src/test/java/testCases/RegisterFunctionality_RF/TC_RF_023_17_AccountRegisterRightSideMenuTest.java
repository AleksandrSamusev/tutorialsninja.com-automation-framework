...
public class TC_RF_023_17_AccountRegisterRightSideMenuTest extends BaseClass {
    @Test(groups = {"Regression", "Master"})
    public void test_whenEmailFormatIncorrect_thenAccountNotCreated() {
        logger.info("");
        logger.info("***  START TC_RF_023_17_AccountRegisterRightSideMenuTest ***");
        try {
        ...
        logger.info("***  END TC_RF_023_17_AccountRegisterRightSideMenuTest ***");
    }
}
