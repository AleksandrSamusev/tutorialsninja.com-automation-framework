...
public class TC_RF_023_13_AccountRegisterTopMenuTest extends BaseClass {
    @Test(groups = {"Regression", "Master"})
    public void test_whenEmailFormatIncorrect_thenAccountNotCreated() {
        logger.info("");
        logger.info("***  START TC_RF_023_13_AccountRegisterTopMenuTest ***");
        try {
        ...
        logger.info("***  END TC_RF_023_13_AccountRegisterTopMenuTest ***");
    }
}
