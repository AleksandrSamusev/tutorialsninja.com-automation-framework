...
public class TC_RF_023_44_AccountRegisterFooterValidationTest extends BaseClass {
    @Test(groups = {"Regression", "Master"})
    public void test_whenEmailFormatIncorrect_thenAccountNotCreated() {
        logger.info("");
        logger.info("***  START TC_RF_023_44_AccountRegisterFooterValidationTest ***");
        try {
            ...
            registrationPage.clickFooterNewsletter();
            logger.info("... click on 'Newsletter' on footer");
        ...
        logger.info("***  END TC_RF_023_44_AccountRegisterFooterValidationTest ***");
    }
}
