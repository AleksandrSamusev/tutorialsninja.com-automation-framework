...
public class TC_RF_011_4_AccountRegisterWithInvalidTelNumberTest extends BaseClass {
    @Test(groups = {"Regression", "Master"})
    public void test_whenEmailFormatIncorrect_thenAccountNotCreated() {
        logger.info("");
        logger.info("***  TC_RF_011_4_AccountRegisterWithInvalidTelNumberTest ***");
        try {
            ...
            String phone = "12345678901234567890123456789012345678901234567890";
