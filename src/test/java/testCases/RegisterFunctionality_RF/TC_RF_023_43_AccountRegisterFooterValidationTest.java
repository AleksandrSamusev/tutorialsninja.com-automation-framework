...
public class TC_RF_023_43_AccountRegisterFooterValidationTest extends BaseClass {
    @Test(groups = {"Regression", "Master"})
    public void test_whenEmailFormatIncorrect_thenAccountNotCreated() {
        logger.info("");
        logger.info("***  START TC_RF_023_43_AccountRegisterFooterValidationTest ***");
        try {
            ...
            registrationPage.clickFooterWishList();
            logger.info("... click on 'Wish List' on footer");
        ...
        logger.info("***  END TC_RF_023_43_AccountRegisterFooterValidationTest ***");
    }
}
