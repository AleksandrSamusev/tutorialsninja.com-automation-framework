...
public class TC_RF_023_7_AccountRegisterHeaderValidationTest extends BaseClass {
    @Test(groups = {"Regression", "Master"})
    public void test_whenEmailFormatIncorrect_thenAccountNotCreated() {
        logger.info("");
        logger.info("***  TC_RF_023_7_AccountRegisterHeaderValidationTest ***");
        try {
            ...
            registrationPage.clickShoppingCart();
            logger.info("... click on 'Shopping Cart' in navbar");
