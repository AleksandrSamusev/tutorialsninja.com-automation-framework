...
public class TC_LF_009_LoginTest extends BaseClass {
    ...
    public void test_userStaysLoggedInAfterClickGoBackInBrowser() {
        logger.info("");
        logger.info("***  START TC_LF_009_LoginTest ***");
        try {
            ...
            logger.info("... from 'Registration' page click 'My Account' in right side menu");
        ...
        logger.info("***  END TC_LF_009_LoginTest ***");
    }
}
