...
public class TC_LF_010_LoginTest extends BaseClass {
    @Test(groups = {"Regression", "Master"})
    public void test_userStaysLoggedOutAfterClickGoBackInBrowser() {
        logger.info("");
        logger.info("***  START TC_LF_010_LoginTest ***");
        try {
            ...
            logger.info("... click browser 'back <--' button");

            myAccountPage.clickRightSideMyAccount();
            logger.info("... from 'My Account' page click 'My Account' in right side menu");

            LoginPage newLoginPage = new LoginPage(driver);
            String msg = newLoginPage.getNewCustomerTitle();
        ...
        logger.info("***  END TC_LF_010_LoginTest ***");
    }
}
